...
<section class="about">
   ...
   <div class="content">
      <h3>Pourquoi nous ?</h3>
      <p>La qualité (caractères organoleptiques et santés ; aspermie) avec en particulier la création de nouveaux produits à forte typicité (couleurs, arômes…) permettant de segmenter le marché ou de créer des labels de qualité est l’objectif central.</p>
      <p>Les travaux d’innovation variétale concernent principalement les petits agrumes (mandariniers et hybrides de mandariniers) et les limettiers.</p>
      <div class="icons-container">
         <div class="icons">
            <i class="fas fa-map"></i>
            <span>top Agrumes</span>
         </div>
         <div class="icons">
            <i class="fas fa-hand-holding-usd"></i>
            <span>Prix bon marché</span>
         </div>
         <div class="icons">
...
<section class="reviews">
   ...
   <h1 class="heading-title">Collaborateurs </h1>
